...
export type DashboardFeedbackReason = {
  reason: string;
  count: number;
  ratio: number;
};
...
export type DashboardFeedbackSummary = {
  ...
  recentNegativeCount24h: number;
  topReasons: DashboardFeedbackReason[];
};

export type DashboardNegativeSample = {
  messageId: string;
...
export type DashboardOverview = {
  ...
  negativeSamples: DashboardNegativeSample[];
};
