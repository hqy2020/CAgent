...
public class BaiLianChatClient implements ChatClient {
    ...
    private JsonArray buildMessages(ChatRequest request) {
        ...
        List<com.openingcloud.ai.ragent.infra.convention.ChatMessage> messages = request.getMessages();
        if (CollUtil.isNotEmpty(messages)) {
            for (com.openingcloud.ai.ragent.infra.convention.ChatMessage m : messages) {
    ...
    private String toOpenAiRole(com.openingcloud.ai.ragent.infra.convention.ChatMessage.Role role) {
        return switch (role) {
            case SYSTEM -> "system";
            case USER -> "user";
