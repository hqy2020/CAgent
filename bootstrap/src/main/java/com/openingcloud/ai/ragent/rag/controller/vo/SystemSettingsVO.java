...
public class SystemSettingsVO {
    ...
    public static class MemorySettings {
        ...
        private Integer historyBudgetTokens;
        private Integer retrievalBudgetTokens;
        private Integer ttlMinutes;
        private Boolean summaryEnabled;
        private Integer summaryStartTurns;
        private Integer summaryTriggerTokens;
    ...
    public static class QueryRewriteSettings {
        ...
        public static class QueryRewriteSettingsBuilder {
            ...
            public QueryRewriteSettingsBuilder maxHistoryTokens(Integer maxHistoryTokens) {
                this.maxHistoryTokens = maxHistoryTokens;
                return this;
            }
            ...
            public QueryRewriteSettings build() {
                return new QueryRewriteSettings(enabled, maxHistoryMessages, maxHistoryTokens, maxHistoryChars);
            }
        }
    }
