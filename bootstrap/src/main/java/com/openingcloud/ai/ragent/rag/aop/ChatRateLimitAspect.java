...
package com.openingcloud.ai.ragent.rag.aop;
...
import com.openingcloud.ai.ragent.rag.config.RagTraceProperties;
...
public class ChatRateLimitAspect {
    ...
    @Around("@annotation(com.openingcloud.ai.ragent.rag.aop.ChatRateLimit)")
