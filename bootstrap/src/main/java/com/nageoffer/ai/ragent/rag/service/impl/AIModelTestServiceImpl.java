...
public class AIModelTestServiceImpl implements AIModelTestService {
    ...
    private ModelTarget buildTarget(AIModelCandidateDO candidateDO, AIModelProviderDO providerDO) {
        com.nageoffer.ai.ragent.infra.config.AIModelProperties.ModelCandidate candidate =
                new com.nageoffer.ai.ragent.infra.config.AIModelProperties.ModelCandidate();
        ...
        com.nageoffer.ai.ragent.infra.config.AIModelProperties.ProviderConfig provider =
                new com.nageoffer.ai.ragent.infra.config.AIModelProperties.ProviderConfig();
